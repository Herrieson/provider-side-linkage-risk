% Submission source moved to ../overleaf/api.tex. This pre-migration working copy is retained for
% provenance; apply future manuscript edits to the Overleaf source.
...
\begin{figure*}[t]
    ...
    interventions attribute score changes against evaluator-only sealed truth. Middle: complementary
    bounded linkage paths recover workflow and entity components. Bottom: direct exposure, workflow
    continuity, and longitudinal propagation support entity linkage, partial profiles, and later
    assignment under provider retention.}
    \label{fig:carp}
\end{figure*}
...
The anonymous artifact includes code, locked dependencies, configs, attack-view generators,

...
Validated on 2026-07-15 after migration into the supplied anonymous AAAI Overleaf template.
...
| Artifact manifest JSON | valid; 128 references / 126 unique paths |
...
| Figure inventory | passed; a combined measurement-framework/CARP figure and a T3 result figure are included, with one supplementary evidence-layer figure retained in the artifact package |
| Overleaf-source migration build | passed; seven body pages and nine pages including references |
| Bibliography and citations | no BibTeX errors or unresolved citations |
| Layout | no overfull boxes; remaining underfull warnings are ordinary two-column line breaks |
...
optional robustness extensions. They are not required by the claims in the current seven-body-page
main paper. Author identities and submission-system metadata remain intentionally unset for
anonymous review.
